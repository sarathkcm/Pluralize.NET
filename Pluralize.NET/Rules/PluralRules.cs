    ...
    internal static class PluralRules
    {
        public static IList<ReplaceRule> GetRules()
        {
            return new List<ReplaceRule>
            {
                ...
                new ReplaceRule { Condition = new Regex("(alumn|syllab|octop|vir|radi|nucle|fung|cact|stimul|termin|bacill|foc|uter|loc|strat)(?:us|i)$",RegexOptions.IgnoreCase),  ReplaceWith = "$1i"},
                ...
                new ReplaceRule { Condition = new Regex("ois$",RegexOptions.IgnoreCase),         ReplaceWith = "$0"},
